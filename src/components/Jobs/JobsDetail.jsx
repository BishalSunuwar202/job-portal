...
const JobsDetail = ({ id, imgUrl, name, position }) => {
  const dispatch = useDispatch();
  const addToSaveJobs = () => {
    dispatch(
      jobActions.addJobToCart({
        id,
        name,
        position,
      })
          ...
          <div>
            <ul className="list-disc">
              <li className="">
                ...
                <p>
                  Market the products of the organization for increasing the
                  loan customers of the organization for maximizing the profit
                  of the organization.
                </p>
              </li>
              <li>
